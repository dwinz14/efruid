    ...
    <div class="max-w-3xl mx-auto space-y-5">
        ...
        @if ($permohonan->status->value === 'PENDING_IT')
            <div class="card card-body" x-data="{ confirm: false, loading: false }">
                ...
                <h3 class="text-sm font-semibold text-slate-800 mb-1">Eksekusi Permohonan</h3>
                ...
                <div x-show="confirm" x-transition>
                    ...
                    <form method="POST" action="{{ route('eksekusi.execute', $permohonan) }}" @submit="loading = true">
                        @csrf
                    ...
                    @if ($permohonan->pdf_path)
                        <a href="{{ route('permohonan.pdf', $permohonan) }}" target="_blank" class="btn-primary btn-sm">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2
                                                 -2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414
