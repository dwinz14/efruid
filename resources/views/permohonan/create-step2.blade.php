            ...
            <div class="card">
                ...
                <div class="card-body grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        <label class="label label-required">Atasan</label>
                        @if ($atasans->isEmpty())
                            <div class="alert-warning">
                                ...
                                <span>Tidak ada user berole Atasan di kantor Anda. Hubungi administrator.</span>
                            </div>
                        @else
                            <select name="atasan_id" class="input @error('atasan_id') input-error @enderror" required>
                                ...
                                @foreach ($atasans as $atasan)
                                    <option value="{{ $atasan->id }}" @selected(old('atasan_id', $draft?->atasan_id) == $atasan->id)>
                                        {{ $atasan->name }} — {{ $atasan->jabatan_label }}
                                    </option>
                                @endforeach
                            </select>
                        @endif
