...
@section('title', 'Riwayat Approval Direktur')
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-fade-up">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-base sm:text-lg font-bold text-slate-800 tracking-tight">Riwayat Persetujuan Direktur
                    </h2>
                    <p class="text-xs sm:text-sm text-slate-500 mt-0.5">
                        Daftar seluruh permohonan FRUID yang pernah anda proses sebagai Direktur
                    </p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fade-up" style="animation-delay: 0.05s;">
            ...
            <div class="bg-white rounded-2xl p-5 border border-slate-200/70 shadow-sm flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Diteruskan ke tahap IT</p>
                </div>
                <div
        ...
        <div class="bg-white rounded-2xl border border-slate-200/70 shadow-sm overflow-hidden animate-fade-up"
            ...
            <div class="px-5 sm:px-6 py-4 border-b border-slate-100 bg-slate-50/60 flex items-center justify-between">
                <div>
                    <h3 class="text-sm sm:text-base font-bold text-slate-800">Daftar Arsip Persetujuan Direktur</h3>
                            ...
                            @foreach ($riwayat as $item)
                                ...
                                <tr class="hover:bg-slate-50/80 transition-colors group">
                                    ...
                                    <td class="px-5 sm:px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-8 h-8 rounded-full bg-purple-100 border border-purple-200 text-purple-700 font-bold text-xs flex items-center justify-center flex-shrink-0">
